...
public class ResetPasswordNotification extends AbstractNotification {
	...
	String getMessageBody() {
		return "Du möchtest dein Passwort zurücksetzen? Folge diesem Link: <a href=\"https://www.cs.technik.fhnw.ch/wodss5/#/" + user.getId() + "?resetCode=" + user.getLoginData().getResetCode() + "\">LINK</a>";
	}
